...
#figura básica con promedios, barras de desviación estándar y cambios en la estética de
#la figura
...
Responde a las siguientes preguntas:
    ...
    d) Desde el punto de vista gráfico ¿qué se gana al pasar de fig1 a fig1.1,
    luego a fig1.2, a fig1.3 y fig1.4?
    e) En el contexto del seguimiento ambiental ¿qué sugiere el resultado?
    f) ¿existen diferencias significativas entre loc1 con loc2? 
    ¿y entre loc1 con loc3? ¿loc3 respecto loc4?
