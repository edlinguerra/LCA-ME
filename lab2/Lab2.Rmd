...
2. Noten el *Laboratorio 2* en la lista de proyectos, e inicien el laboratorio (*START*)

3. Una vez dentro del proyecto, abrirán los archivos Lab2.Rmd, lab2_e1.R y lab2_e2.R en las carpeta **lab2**

4. Desde Lab2.Rmd active *Preview in Viewer Pane* y aplique *Knit*. Puede ahora visualizar la guía desde R-Studio sin necesidad de cambiar de ventanas en su pantalla

5. Lea los pasos de las actividades desde el Viewer de R-Studio y responda y ejecute los comandos desde el archivo de comandos lab2_e1.R para el ejercicio 1 y lab2_e2.R para el ejercicio 2.
